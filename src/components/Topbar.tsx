...
const Topbar = () => {
  ...
  return (
    <header className="h-14 bg-white/80 backdrop-blur-md border-b border-slate-100 flex items-center justify-between px-3 md:px-8 fixed top-0 left-0 right-0 md:right-24 z-30 transition-colors duration-300">
